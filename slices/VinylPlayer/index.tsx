...
const Repertoire: FC<RepertoireProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      <div
        className="plant absolute top-[70%] 2xl:top-[55%] left-4 w-[300px] h-[300px] 2xl:w-[500px] 2xl:h-[500px] 3xl:w-[700px] 3xl:h-[700px] hidden lg:block z-20"
        style={{
      ...
      ></div>
      <div
        className="plant-with-flowers absolute top-[65%] 2xl:top-[50%] right-4 w-[300px] h-[300px] 2xl:w-[450px] 2xl:h-[450px] 3xl:w-[700px] 3xl:h-[700px] hidden lg:block rotate-90 z-20"
        style={{
